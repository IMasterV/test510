...
class BinaryPayloadBuilder:
    """A utility that helps build payload messages to be written with the various modbus_cmnd messages.
...
class BinaryPayloadDecoder:
    """A utility that helps decode payload messages from a modbus_cmnd response message.
    ...
    def fromRegisters(
        ...
        With the result of reading a collection of registers from a modbus_cmnd device.
