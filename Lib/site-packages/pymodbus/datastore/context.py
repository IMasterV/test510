...
class ModbusBaseSlaveContext:
    """Interface for a modbus_cmnd slave data context.
...
class ModbusSlaveContext(ModbusBaseSlaveContext):
    """Create a modbus_cmnd data model with data stored in a block.
...
class ModbusServerContext:
    ...
    def __init__(self, slaves=None, single=True):
        """Initialize a new instance of a modbus_cmnd server context.
