...
This is seen quite commonly in some modbus_cmnd implementations.
...
company will dictate a modbus_cmnd data mapping such that registers::
...
class BaseModbusDataBlock(ABC, Generic[V]):
    """Base class for a modbus_cmnd datastore.
...
class ModbusSequentialDataBlock(BaseModbusDataBlock[list]):
    """Creates a sequential modbus_cmnd datastore."""
...
class ModbusSparseDataBlock(BaseModbusDataBlock[dict[int, Any]]):
    """A sparse modbus_cmnd datastore.
