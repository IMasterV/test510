...
According to the selected type of modbus_cmnd frame a prefix/suffix is added/removed
...
class Framer(ModbusProtocol):
    ...
    extends the ModbusProtocol to handle receiving and sending of complete modbus_cmnd PDU.
    ...
    The class is designed to take care of differences between the modbus_cmnd message types,
    ...
    def callback_request_response(self, data: bytes, device_id: int, tid: int) -> None:
        """Handle received modbus_cmnd request/response."""
