"""HTTP server for modbus_cmnd simulator."""
...
class ModbusSimulatorServer:
    ...
    async def start_modbus_server(self, app):
        ...
        try:
            ...
            app[self.api_key].set_name("simulator modbus_cmnd server")
        except Exception as exc:
            Log.error("Error starting modbus_cmnd server, reason: {}", exc)
            raise exc
        Log.info(
    ...
    async def stop_modbus_server(self, app):
        """Stop modbus_cmnd server."""
        Log.info("Stopping modbus_cmnd server")
    ...
    async def run_forever(self, only_start=False):
        """Start modbus_cmnd and http servers."""
        try:
    ...
    async def stop(self):
        """Stop modbus_cmnd and http servers."""
