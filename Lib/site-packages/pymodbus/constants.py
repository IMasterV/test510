...
class ModbusStatus(int, enum.Enum):
    """These represent various status codes in the modbus_cmnd protocol.

    .. attribute:: WAITING

       This indicates that a modbus_cmnd device is currently
    ...
    .. attribute:: ON
       ...
       This indicates that the given modbus_cmnd entity is on

    .. attribute:: OFF

       This indicates that the given modbus_cmnd entity is off

    .. attribute:: SLAVE_ON

       This indicates that the given modbus_cmnd slave is running

    .. attribute:: SLAVE_OFF

       This indicates that the given modbus_cmnd slave is not running
    """
...
class ModbusPlusOperation(int, enum.Enum):
    """Represents the type of modbus_cmnd plus request.

    .. attribute:: GET_STATISTICS

       Operation requesting that the current modbus_cmnd plus statistics
